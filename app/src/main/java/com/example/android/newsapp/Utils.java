...
public final class Utils {
    ...
    /**
     * Query the guardianapis dataset and return a arrayList of {@link News} objects.
     */
    public static ArrayList<News> fetchNewsData(String requestUrl) {
        ...
        // Extract relevant fields from the JSON response and create a arrayList of {@link News}
    ...
    /**
     * Return a arrayList of {@link News} objects that has been built up from
    ...
    private static ArrayList<News> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            for (int i = 0; i < resultsArray.length(); i++) {
                ...
                // Create a new {@link News} object with the title, sectionName, time,
                // and url from the JSON response.
                News news1 = new News(title, sectionName, time, url);
